...
- Updates
	...
	- JeCobblemon Datapack - v0.2 `->` v0.3
		- Adds many new mod integrations. See [changelog](https://github.com/WxAaRoNxW/JeCobblemon-Mod-Integration/blob/master/CHANGELOG.md) for info.
	...
	- Notable Updates
		...
		- <b>Radical Cobblemon Trainers</b>: rctmod-fabric-1.21.1-0.14.1-beta.jar `->` rctmod-fabric-1.21.1-0.14.2-beta.jar
		...
		- <b>Cobblemon: Mega Showdown</b>: Cobblemon_MegaShowdown-7.3.0-release-fabric.jar `->` Cobblemon_MegaShowdown-8.1.0-release-fabric.jar
